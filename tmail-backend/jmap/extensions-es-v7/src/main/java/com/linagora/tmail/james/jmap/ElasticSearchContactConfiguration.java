...
public class ElasticSearchContactConfiguration {
    ...
    public static final Integer DEFAULT_MAX_NGRAM_DIFF = 5;
    ...
    static Optional<Integer> computeMaxNgramDiff(Configuration configuration) {
        return Optional.ofNullable(configuration.getInt(ELASTICSEARCH_INDEX_CONTACT_MAX_NGRAM_DIFF));
    }

    static Optional<Integer> computeMinNgram(Configuration configuration) {
        return Optional.ofNullable(configuration.getInt(ELASTICSEARCH_INDEX_CONTACT_MIN_NGRAM));
    }
