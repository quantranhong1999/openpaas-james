...
class FirebaseClientTest {
    public static final FirebaseToken VALID_TOKEN = new FirebaseToken("change_me");
    public static final FirebaseToken INVALID_TOKEN = new FirebaseToken("invalid_token");
    public static final String VALID_KEY_URL = "src/test/resources/valid-firebase-private-key.json";
