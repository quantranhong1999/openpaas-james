...
class RabbitMQAndRedisEventBusTestWithRedisSentinel implements GroupContract.SingleEventBusGroupContract, GroupContract.MultipleEventBusGroupContract,
    ...
    private RabbitMQAndRedisEventBus newEventBus(NamingStrategy namingStrategy, Sender sender, ReceiverProvider receiverProvider) throws Exception {
        return new RabbitMQAndRedisEventBus(namingStrategy, sender, receiverProvider, eventSerializer,
            ...
            new RedisEventBusClientFactory(redisExtension.getRedisSentinelCluster().redisSentinelContainerList().getRedisConfiguration()),
